...
public class ExtenderIncrementSetpoint extends CommandBase {
  ...
  public ExtenderIncrementSetpoint(int direction) {
    // Use addRequirements() here to declare subsystem dependencies. 
    m_ExtenderSubsystem = Robot.m_extenderSubsystem;
    addRequirements(m_ExtenderSubsystem);
    this.setPoint = Math.max(Math.min(m_ExtenderSubsystem.currentSetpoint + direction, 4), 1);
  }
